...
const DEFAULT_DATA = {
    ...
    about: {
        ...
        title: "24+ Years of Precision Engineering & Door Automation Excellence",
        subtitle: "The trusted leader for high-security residential roller garage doors, industrial shutters, and motorized expandable gates in Sri Lanka.",
        desc1: "Established with a commitment to engineering precision and uncompromising material standards, Shutter 2000 International (Pvt) Ltd has grown into one of Sri Lanka's foremost manufacturers and installers of total door solutions.",
        desc2: "Operating from our advanced 15,000 sq.ft engineering complex in Ratmalana, we combine imported high-yield Australian BlueScope steel coils, Japanese & European drive motors, and precision CNC fabrication to deliver whisper-quiet, hurricane-durable roller shutters and gate automation systems.",
        experienceYears: "24+",
        experienceText: "Years of Engineering Rigor",
        certBadge: "ISO Certified Standards & 100% Copper Coil Motors",
        image1: "images/factory_plant.jpg",
        image2: "images/installation_crew.jpg",
        checklist: [
            "Australian AZ150 Zinc-Alum Alloy with 4-Layer Anti-Corrosion Coating",
            "Whisper-Quiet Nylon Webbing Strip Technology for Smooth, Silent Rolling",
            "Emergency Manual Chain Hoist and Key Disconnect for Power Outages",
            "Smart IoT Smartphone Control with Live Security Status Notifications",
            "Dedicated Mobile Service Fleet Supporting All 9 Provinces Islandwide"
        ]
    },
    categories: [
    ...
    products: [
        {
            ...
            material: "0.50mm - 0.60mm AZ150 Australian Zinc-Alum Steel with Anti-Corrosion Primer",
            availableColors: "Caulfield Green, Slate Grey, Teak Woodgrain, Off White, Silver, Black",
            maxDimensions: "Width up to 22ft | Height up to 18ft (Continuous Sheet / Slats)",
            operationMode: "Wireless Remote Control + Smartphone Wi-Fi App + Manual Key Disconnect",
            applications: "Residential Garages, Commercial Retail Outlets, Private Villa Enclosures",
            priceGuide: "Starting from LKR 450 / sq.ft (Customized to opening size)",
            features: [
        ...
        },
        {
            ...
            material: "0.80mm - 1.20mm Electro-Galvanised Steel Curved Interlocking Slats",
            availableColors: "Galvanised Silver, Slate Grey, Industrial Blue, Custom RAL Powder Coat",
            maxDimensions: "Width up to 35ft | Height up to 28ft",
            operationMode: "Industrial Push Button Station + Remote Keyfob + Manual Chain Hoist Backup",
            applications: "Factory Loading Bays, Logistic Distribution Hubs, Port Warehouses",
            priceGuide: "Custom industrial project quotation based on span & wind-load requirement",
            features: [
        ...
        },
        {
            ...
            material: "3.0mm Impact-Resistant UV-Stabilized Polycarbonate + Anodized Aluminium Ribs",
            availableColors: "95% Crystal Clear Transparent Panels with Natural Silver or Matte Black Frame",
            maxDimensions: "Width up to 20ft | Height up to 14ft",
            operationMode: "Silent Tubular Motor + Wall Switch + Wireless Remote + Smart Access",
            applications: "Shopping Mall Boutiques, Bank Counters, Automobile Showrooms",
            priceGuide: "Premium showroom specification quotation",
            features: [
        ...
        },
        {
            ...
            material: "0.80mm Galvanised Steel Micro-Perforated or Heavy-Gauge Solid Round Bar Grill",
            availableColors: "Matte Black, Pure White, Architectural Grey, Custom Oven-Baked Powder Coat",
            maxDimensions: "Width up to 24ft | Height up to 16ft",
            operationMode: "Motorized Remote + Key Switch + Emergency Spring Balanced Push-Up",
            applications: "Jewelry Showrooms, Arcade Storefronts, Underground Car Park Ventilation",
            priceGuide: "Quotation tailored to perforation pattern and span dimensions",
            features: [
        ...
        },
        {
            ...
            material: "Grade 304 Stainless Steel (Anti-Rust, Salt-Spray Resistant) Heavy Rhombus Structure",
            availableColors: "High-Gloss Mirror Stainless Steel, Brushed Satin Stainless Steel",
            maxDimensions: "Length up to 100ft | Height: 1.6m / 1.8m / 2.0m",
            operationMode: "Trackless Magnetic Navigation or Rail Guided + Remote Control + Wireless Desktop Switch",
            applications: "Government Institutions, Corporate Headquarters, Factory Main Entrances, Schools",
            priceGuide: "Calculated per linear meter + automation package",
            features: [
        ...
        },
        {
            ...
            material: "Heavy Hollow Structural Steel / Wrought Iron with Epoxy Zinc Anti-Rust Undercoat",
            availableColors: "Matte Charcoal, Gloss Black, Timber Composite Infill, Dark Bronze",
            maxDimensions: "Single Leaf Span up to 30ft | Dual Leaf up to 60ft",
            operationMode: "High-Torque Gear Rack Motor + Long-Range Remotes + Photocell Safety Sensors",
            applications: "Industrial Gates, Gated Communities, Private Residences, Farm Estates",
            priceGuide: "Custom fabricated to architectural drawings",
            features: [
        ...
        },
        {
            ...
            material: "0.9mm - 1.2mm High-Density Industrial PVC Fabric + Full-Width Transparent Window",
            availableColors: "Safety Yellow, High-Visibility Orange, Deep Blue, Clean Room White",
            maxDimensions: "Width up to 18ft | Height up to 18ft",
            operationMode: "Radar Motion Detector + Induction Floor Loop + Push Button + Pull Cord",
            applications: "Pharmaceutical Plants, Food Processing Facilities, Cold Storage Logistics",
            priceGuide: "High-speed clean room package quotation",
            features: [
        ...
        },
        {
            ...
            material: "Flame-Retardant ABS Enclosure with Integrated Relay Outputs & Status Sensors",
            availableColors: "Matte Black",
            maxDimensions: "Universal Compatibility with Any Motorized Door / Gate Brand",
            operationMode: "iOS / Android App + GSM Call + RFID Tag + Rolling Code Remote",
            applications: "Smart Home Residences, Multi-Tenancy Apartments, Commercial Gate Access",
            priceGuide: "LKR 18,500 Complete Retrofit Kit (Includes Installation in Western Province)",
            features: [
        ...
        },
        {
            ...
            material: "100% Pure Copper Coils + Precision CNC Alloy Gears",
            availableColors: "Universal OEM Replacement Specs",
            maxDimensions: "Standard 300kg / 600kg / 800kg / 1000kg / 1500kg Motor Capacities",
            operationMode: "Single Phase 230V / Three Phase 415V with Built-In Mechanical Limit Switches",
            applications: "Repairs, Motor Upgrades, Automation Conversions for All Door Brands",
            priceGuide: "Direct factory warehouse import rates",
            features: [
